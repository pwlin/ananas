var utils = {
         ...
         * Modified from http://james.padolsey.com/javascript/javascript-comment-removal-revisted/
         * @param {string} str
         * @returns {string}
         */
        ...
        /**
         * Merge 2 objects
         * Modified from http://stackoverflow.com/a/383245/374577
         * @param {object} obj1
         * @param {object} obj2
         * @returns {object} obj1
         */
...
exports.remove_comments = function(str) {
    return utils.remove_comments(str);
};
exports.format_date = function(date, format) {
    return utils.format_date(date, format);
};
exports.url_decode = function(str) {
    return utils.url_decode(str);
};
exports.nice_size = function(bytes) {
    return utils.nice_size(bytes);
};
exports.trim = function(str) {
    return utils.trim(str);
};
exports.merge_objects = function(obj1, obj2) {
    return utils.merge_objects(obj1, obj2);
};
